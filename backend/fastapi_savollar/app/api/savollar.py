...
from ...app.schemas.savollar import SavollarCreate, SavollarDelete, SavollarUpdate, SavollarRead, GetSavollarRequest
from ...app.crud.savollar import (
    create_savollar,
    get_savollar_by_id,
    get_savollar_by_savol_id,
